...
function createDOMNodes(page) {
    ...
    if (page === 'results') {
        ...
        saveText.setAttribute('onclick', `removeFavorite('${result.url}')`);  // to add onclick event attribute, use setAttribute function
    }
    // Card Text
...
function updateDOM(page) {
    ...
    imagesContainer.textContent = ''; // Reset imagesContainer(remove all elements appended to imagesContainer)
    createDOMNodes(page);
    showContent(page);
}
